		...
		10 {
			...
			renderObj {
				...
				10 {
					...
					stdWrap.wrap = <div class="site-blocks-cover inner-page overlay" style="background-image: url(/omb-maschinenfabrik.ch/|);" data-aos="fade" data-stellar-background-ratio="0.5">
				}
