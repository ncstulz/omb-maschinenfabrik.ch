lib.slider {
	...
	slides {
		...
		10 {
			...
			renderObj = COA
			renderObj {
				stdWrap.dataWrap =  <div class="site-blocks-cover inner-page overlay" data-aos="fade" data-stellar-background-ratio="0.5">|</div>
				...
				20 {
					...
					wrap = <div class="container"><div class="row align-items-center justify-content-center"><div class="col-md-6 text-center" data-aos="fade">|</div></div></div></div>
					...
					10 {
						...
						# wrap description
						stdWrap.wrap = <h1 class="text-uppercase font-white">|</h1>
						stdWrap.required = 1
					}
